        ...
        .then(async times => {
          ...
          for (let prayerName in pTimes) {
            if (notificationStatuses[prayerName]) {
              ...
              dispatch(
                updateNotificationID({ pNameNotification, notificationID })
              )
            }
          }
        })
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text
          style={[
            styles.date,
            {
              marginBottom: 0,
              color: !(
                showTmrwTimes && new Date().getDate() == date.split(' ')[1]
              )
                ? '#444444'
                : 'red',
            },
        ...
        >
          {showTmrwTimes ? gregDate.tomorrow : gregDate.today}
        </Text>
        ...
        <View style={{ alignItems: 'center' }}>
          ...
          >
            <Table prayerTimes={prayerTimes} highlight={highlight} />
          </Animated.View>
          <Animated.View
            style={{
              position: 'absolute',
